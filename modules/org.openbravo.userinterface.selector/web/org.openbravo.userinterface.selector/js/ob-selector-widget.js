...
isc.OBSelectorWidget
  ...
  // ** {{{ openSelectorWindow }}} **
      ...
      checkDefaultValidations : function(form, item) {
        var missingSpan = document
            .getElementById(this.openbravoField.id + 'missingSpan');
        var invalidSpan = document
            .getElementById(this.openbravoField.id + 'invalidSpan');
      ...
      initWidget : function() {
        ...
        OB.TestRegistry.register(baseTestRegistryName + 'selectorField',
            this.selectorField);
        ...
        if (this.showSelectorGrid) {
          ...
          OB.TestRegistry.register(baseTestRegistryName + 'selectorWindow',
              this.selectorWindow);
